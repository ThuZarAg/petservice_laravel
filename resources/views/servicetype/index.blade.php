...
@section('content')
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h2 class="d-inline-block">Services List</h2>
          <a href="{{route('servicetype.create')}}" class="btn btn-info float-right">Add New</a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{route('servicetype.show',$row->id)}}" class="btn btn-info">Show</a>
                  <form method="post" action="{{route('servicetype.destroy',$row->id)}}" class="d-inline-block" onsubmit="return confirm('Are you Sure to Delete?')">
                    @csrf
                    @method('DELETE')
